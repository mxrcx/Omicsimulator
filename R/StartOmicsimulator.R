...
## result <- Omicsimulator(disease = "Breast cancer", sample_number = 10, top_DEG_number = 1000, output_directory = "../output", file_prefix = "omicsimulatorResults_Breast cancer_10_1000", threshold_eQTls = 0.7)
##
...
## result <- Omicsimulator(disease = "Breast cancer", sample_number = 10, top_DEG_number = 1000, threshold_eQTls = 0.7)
##
