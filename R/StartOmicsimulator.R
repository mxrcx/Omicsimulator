...
## result <- Omicsimulator(disease = disease, sample_number = 10, top_DEG_number = 1000, output_directory = "../output", file_name = "omicsimulatorResults_Breast cancer_10_1000")
##
...
##
## Output folder and file name of the output file are standard values as seen in the docs.
## result contains a list which contains two matrices from DEA (normal-tumor and normal-simulated) with gene name, gene expression value, fold change and p-value
